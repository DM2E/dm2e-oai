...
public class Export_DM2E_to_DC {
	...
	public Export_DM2E_to_DC(String endpoint, String outputDirectory) {
		...
		ns.put("", Namespace.getNamespace("", "http://www.openarchives.org/OAI/2.0/"));
		ns.put("oai", Namespace.getNamespace("oai", "http://www.openarchives.org/OAI/2.0/"));
		ns.put("http://www.openarchives.org/OAI/2.0/", Namespace.getNamespace("", "http://www.openarchives.org/OAI/2.0/"));
		ns.put("oai_dc", Namespace.getNamespace("oai_dc", "http://www.openarchives.org/OAI/2.0/oai_dc/"));
		ns.put("http://www.openarchives.org/OAI/2.0/oai_dc/", Namespace.getNamespace("oai_dc", "http://www.openarchives.org/OAI/2.0/oai_dc/"));
		ns.put("rights", Namespace.getNamespace("rights", "http://www.openarchives.org/OAI/2.0/rights/"));
		ns.put("http://www.openarchives.org/OAI/2.0/rights/", Namespace.getNamespace("rights", "http://www.openarchives.org/OAI/2.0/rights/"));
